...
export function LeaderboardSection() {
  return (
    <section
      className="w-full bg-background py-10 md:py-14 section-pitch"
      id="trusted-rankings"
      aria-labelledby="trusted-rankings-heading"
    >
      <div className="container mx-auto max-w-6xl px-4 md:px-6">
        ...
        <div className="mb-5 flex items-center justify-between">
          <div>
            <p className="text-[11px] font-heading font-semibold uppercase tracking-widest text-primary mb-1">
              Verified Rankings {new Date().getFullYear()}
            </p>
            <h2
              id="trusted-rankings-heading"
        ...
        >
          ...
          <p className="text-[11px] text-muted-foreground leading-relaxed">
            Rankings on Trusted UK Betting Sites List are produced through independent editorial review. We may earn affiliate commission when you visit an operator via our links — this has no bearing on our ratings or scores. Every listed operator holds an active UKGC licence.{" "}
